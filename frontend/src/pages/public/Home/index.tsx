    ...
    <div className="w-full h-full">
      <section className="bg-white">
        ...
        <div className="w-full flex justify-center flex-wrap gap-4 ">
          <Button href="" color="purple">Programação</Button>
          <Button href="" color="red">Matemática</Button>
          <Button href="" color="green">Marketing</Button>
          <Button href="" color="yellow">Gestão</Button>
          <Button href="" color="blue">Idiomas</Button> 
        </div>
